            ...
            <div className="flex flex-col items-center mt-10">
              <div className="w-full max-w-md">
                <div className="flex flex-wrap justify-between gap-3 p-4">
                  <p className="text-[#0d171b] text-4xl font-black leading-tight tracking-[-0.033em] w-full text-center">Welcome Back</p>
                </div>
                ...
                <div className="p-4 space-y-6">
                  <div className="flex flex-col gap-4">
                    ...
                    <label className="flex flex-col min-w-40 flex-1">
                      <p className="text-[#0d171b] text-base font-medium leading-normal pb-2">Password</p>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      <input
                        className="form-checkbox h-4 w-4 rounded text-[#13a4ec] focus:ring-[#13a4ec] border-gray-300"
                        id="remember-me"
                        type="checkbox"
                      />
                      <label
                        className="text-[#4c809a] text-sm"
                        htmlFor="remember-me"
                      >
                        Remember me
                      </label>
                    </div>
                    <a className="text-sm text-[#13a4ec] hover:underline" href="#">
                      Forgot Password?
                    </a>
                  </div>
                  ...
                  <p className="text-center text-sm text-[#4c809a]">
                    ...
                    {" "}
                    <a className="text-[#13a4ec] font-bold hover:underline" href="/register">Create one</a>
                  </p>
