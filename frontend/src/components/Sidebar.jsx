          ...
          <div>
            ...
            <div className="mt-2 space-y-2">
              <div className="flex items-center">
                <input id="electronics" name="category" type="checkbox" className="h-4 w-4 text-[#3498DB] focus:ring-[#3498DB] border-gray-300 rounded" />
                <label htmlFor="electronics" className="ml-2 text-sm text-[#4c809a]">Electronics</label>
              </div>
              <div className="flex items-center">
                <input id="books" name="category" type="checkbox" className="h-4 w-4 text-[#3498DB] focus:ring-[#3498DB] border-gray-300 rounded" />
                <label htmlFor="books" className="ml-2 text-sm text-[#4c809a]">Books</label>
              </div>
              <div className="flex items-center">
                <input id="games" name="category" type="checkbox" className="h-4 w-4 text-[#3498DB] focus:ring-[#3498DB] border-gray-300 rounded" />
                <label htmlFor="games" className="ml-2 text-sm text-[#4c809a]">Games</label>
              </div>
              <div className="flex items-center">
                <input id="furniture" name="category" type="checkbox" className="h-4 w-4 text-[#3498DB] focus:ring-[#3498DB] border-gray-300 rounded" />
                <label htmlFor="furniture" className="ml-2 text-sm text-[#4c809a]">Furniture</label>
              </div>
              <div className="flex items-center">
                <input id="toys" name="category" type="checkbox" className="h-4 w-4 text-[#3498DB] focus:ring-[#3498DB] border-gray-300 rounded" />
                <label htmlFor="toys" className="ml-2 text-sm text-[#4c809a]">Toys</label>
              </div>
              <div className="flex items-center">
                <input id="apparel" name="category" type="checkbox" className="h-4 w-4 text-[#3498DB] focus:ring-[#3498DB] border-gray-300 rounded" />
                <label htmlFor="apparel" className="ml-2 text-sm text-[#4c809a]">Apparel</label>
              </div>
              <div className="flex items-center">
                <input id="musical_instruments" name="category" type="checkbox" className="h-4 w-4 text-[#3498DB] focus:ring-[#3498DB] border-gray-300 rounded" />
                <label htmlFor="musical_instruments" className="ml-2 text-sm text-[#4c809a]">Musical Instruments</label>
              </div>
              <div className="flex items-center">
                <input id="shoes" name="category" type="checkbox" className="h-4 w-4 text-[#3498DB] focus:ring-[#3498DB] border-gray-300 rounded" />
